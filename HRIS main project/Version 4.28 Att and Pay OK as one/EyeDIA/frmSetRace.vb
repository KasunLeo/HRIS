Public Class frmSetRace
    ...
    Private Sub frmDistricts_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'sqlQRY = "CREATE TABLE tblRace (cID Nvarchar (3),cDesc Nvarchar (100),Status Numeric (18,0),CompID Nvarchar (3))" : FK_EQ(sqlQRY, "S", "", False, False, False)
        'sqlQRY = "ALTER TABLE tblControl ADD NoRace Numeric (18,0) NOT NULL Default 0" : FK_EQ(sqlQRY, "S", "", False, False, False)
    ...
    Private Sub cmdRefresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRefresh.Click
        ...
        txtCode.Text = fk_GenSerial("SELECT NoRace FROM tblControl", 3)
        StrSvStatus = "S"

    End Sub

    Public Sub _LoadDocs()
        sqlQRY = "SELECT cID,cDesc ,Status FrOM tblRace Order by cID"
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Select Case StrSvStatus
            Case "S"
                txtCode.Text = fk_GenSerial("SELECt NoRace FROM tblControl", 3)
                sqlQRY = "INSERT INTO tblRace (cID,cDesc,Status,CompID) VALUES ('" & txtCode.Text & "','" & txtDesc.Text & "'," & chkStatus.CheckState & ",'" & StrCompID & "')"
                sqlQRY = sqlQRY & "UPDATE tblControl SET NoRace = NoRace + 1"
            Case "E"
                sqlQRY = "UPDATe tblRace SET cDesc = '" & txtDesc.Text & "',Status = " & chkStatus.CheckState & " WHERe cID = '" & txtCode.Text & "'"
        End Select
    ...
    Private Sub dgvData_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dgvData.DoubleClick
        ...
        sqlQRY = "SELECT cID,cDesc,Status,CompID FROM tblRace WHERE cID = '" & txtCode.Text & "'"
