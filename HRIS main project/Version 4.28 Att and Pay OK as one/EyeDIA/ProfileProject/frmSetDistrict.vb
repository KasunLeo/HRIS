Public Class frmSetDistricts
    ...
    Private Sub frmDistricts_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        sqlQRY = "CREATE TABLE tblDistrict (cID Nvarchar (3),cDesc Nvarchar (100),Status Numeric (18,0),CompID Nvarchar (3))" : FK_EQ(sqlQRY, "S", "", False, False, False)
        sqlQRY = "ALTER TABLE tblControl ADD NoDist Numeric (18,0) NOT NULL Default 0" : FK_EQ(sqlQRY, "S", "", False, False, False)
    ...
    Public Sub _LoadDocs()
        sqlQRY = "SELECT cID,cDesc ,Status FrOM tblDistrict Order by cID"
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Select Case StrSvStatus
            Case "S"
                txtCode.Text = fk_GenSerial("SELECt NoDist FROM tblControl", 3)
                sqlQRY = "INSERT INTO tblDistrict (cID,cDesc,Status,CompID) VALUES ('" & txtCode.Text & "','" & txtDesc.Text & "'," & chkStatus.CheckState & ",'" & StrCompID & "')"
                sqlQRY = sqlQRY & "UPDATE tblControl SET NoDist = NoDist + 1"
            Case "E"
                sqlQRY = "UPDATe tblDistrict SET cDesc = '" & txtDesc.Text & "',Status = " & chkStatus.CheckState & " WHERe cID = '" & txtCode.Text & "'"
        End Select
    ...
    Private Sub dgvData_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dgvData.DoubleClick
        ...
        sqlQRY = "SELECT cID,cDesc,Status,CompID FROM tblDistrict WHERE cID = '" & txtCode.Text & "'"
