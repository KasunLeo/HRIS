Public Class frmSetCities
    ...
    Public Sub _LoadDocs()
        sqlQRY = "SELECT cID,cDesc ,Status FrOM tblCities Order by cID"
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Select Case StrSvStatus
            Case "S"
                txtCode.Text = fk_GenSerial("SELECt NoCity FROM tblControl", 3)
                sqlQRY = "INSERT INTO tblCities (cID,cDesc,Status,CompID) VALUES ('" & txtCode.Text & "','" & txtDesc.Text & "'," & chkStatus.CheckState & ",'" & StrCompID & "')"
                sqlQRY = sqlQRY & "UPDATE tblControl SET NoCity = NoCity + 1"
            Case "E"
                sqlQRY = "UPDATe tblCities SET cDesc = '" & txtDesc.Text & "',Status = " & chkStatus.CheckState & " WHERe cID = '" & txtCode.Text & "'"
        End Select
    ...
    Private Sub dgvData_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dgvData.DoubleClick
        ...
        sqlQRY = "SELECT cID,cDesc,Status,CompID FROM tblCities WHERE cID = '" & txtCode.Text & "'"
