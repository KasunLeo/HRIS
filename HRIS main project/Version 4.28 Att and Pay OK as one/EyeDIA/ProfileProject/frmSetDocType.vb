Public Class frmSetDocType
    ...
    Private Sub cmdRefresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRefresh.Click
        ...
        txtCode.Text = fk_GenSerial("SELECT NoDocs FROM tblControl", 3)
        StrSvStatus = "S"

    End Sub

    Public Sub _LoadDocs()
        sqlQRY = "SELECT cID,cDesc ,Status FrOM tblDocType Order by cID"
    ...
    Private Sub dgvData_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dgvData.DoubleClick
        ...
        sqlQRY = "SELECT cID,cDesc,Status,CompID FROM tblDocType WHERE cID = '" & txtCode.Text & "'"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Select Case StrSvStatus
            Case "S"
                txtCode.Text = fk_GenSerial("SELECt NoDocs FROM tblControl", 3)
                sqlQRY = "INSERT INTO tblDocType (cID,cDesc,Status,CompID) VALUES ('" & txtCode.Text & "','" & txtDesc.Text & "'," & chkStatus.CheckState & ",'" & StrCompID & "')"
                sqlQRY = sqlQRY & "UPDATE tblControl SET NoDocs = NoDocs + 1"
            Case "E"
                sqlQRY = "UPDATe tblDocType SET cDesc = '" & txtDesc.Text & "',Status = " & chkStatus.CheckState & " WHERe cID = '" & txtCode.Text & "'"
        End Select
