Public Class frmSetBloodType
    ...
    Private Sub cmdRefresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRefresh.Click
        ...
        txtCode.Text = fk_GenSerial("SELECT NoBldTyp FROM tblControl", 3)
        StrSvStatus = "S"

    End Sub

    Public Sub _LoadDocs()
        sqlQRY = "SELECT cID,cDesc ,Status FrOM tblBloodType Order by cID"
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Select Case StrSvStatus
            Case "S"
                txtCode.Text = fk_GenSerial("SELECt NoBldTyp FROM tblControl", 3)
                sqlQRY = "INSERT INTO tblBloodType (cID,cDesc,Status,CompID) VALUES ('" & txtCode.Text & "','" & txtDesc.Text & "'," & chkStatus.CheckState & ",'" & StrCompID & "')"
                sqlQRY = sqlQRY & "UPDATE tblControl SET NoBldTyp = NoBldTyp + 1"
            Case "E"
                sqlQRY = "UPDATe tblBloodType SET cDesc = '" & txtDesc.Text & "',Status = " & chkStatus.CheckState & " WHERe cID = '" & txtCode.Text & "'"
        End Select
    ...
    Private Sub dgvData_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dgvData.DoubleClick
        ...
        sqlQRY = "SELECT cID,cDesc,Status,CompID FROM tblBloodType WHERE cID = '" & txtCode.Text & "'"
