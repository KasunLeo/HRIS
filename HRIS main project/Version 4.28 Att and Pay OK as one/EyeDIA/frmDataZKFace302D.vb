...
Public Class frmDataZKFace302D
    ...
    Private Sub cmdDownload_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDownload.Click, Button1.Click
        ...
        Else
            ...
            Do While objReader.EndOfStream = False
                ...
                Catch ex As Exception
                    MsgBox(ex.Message + " Last record is : " + StrEmp + " " + dtAtDate, MsgBoxStyle.Information)
                    Exit Sub
                End Try
            Loop
        ...
        With dgvData
            For iRw = 0 To .RowCount - 1
                sqlQRY = sqlQRY & " INSERT INTO tblAllDownData (MacID,crLine,EmpID,VrfyMode,Input,cDate,cTime,WrkCode,Capture,tTime,EditMode,dAID,dStatus) VALUES " & _
               " ('" & StrDivNo & "'," & CInt(.Item(0, iRw).Value) & ",'" & .Item(1, iRw).Value & "','" & .Item(2, iRw).Value & "', " & _
               " '" & .Item(3, iRw).Value & "', '" & CDate(.Item(4, iRw).Value) & "','" & CDate(.Item(5, iRw).Value) & "','" & .Item(6, iRw).Value & "',0,'',0," & intTriD & ",0)"
                pgbUpdate.Value = pgbUpdate.Value + 1 : intBLKCount = intBLKCount + 1

                If intBLKCount = 500 Then bolProcess = FK_EQ(sqlQRY, "P", "", False, False, True) : intBLKCount = 0 : sqlQRY = ""
            Next
        End With
        If sqlQRY <> "" Then
        ...
        Try
            ...
            If dgvEmp.RowCount - 1 > 0 Then
                ...
                With dgvEmp
                    ...
                    For i As Integer = 0 To .RowCount - 1
                        ...
                        End If
                    Next
                    bolHasRecord = FK_EQ(sqlQRY, "P", "", False, True, True)
            ...
            sSQL = "INSERT INTO tblDownloadHistory (dAID,crUser,crTime,dDesc,dCount,dStatus) VALUES (" & intTriD & ",'" & StrUserID & "',getDate(),'Download Data ZK Face 302 - " & StrDivNo & "'," & intNewDownload & ",0)" : FK_EQ(sSQL, "P", "", False, False, True)

            'Update last downlod date for processed data 20170808
            sSQL = "declare @ldate as datetime; select @ldate= isnull([lastprocessed],'1900-01-01') from [tblDeviceInfo] WHERE [MachinID]='" & StrDivNo & "' " & _
    ...
    Private Sub optDevice_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optDevice.CheckedChanged, optFile.CheckedChanged
    ...
    Private Sub cmdConnect_D_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub cmdDownload_D_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDownload_D.Click
