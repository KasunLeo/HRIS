...
Public Class frmSetSubDepts
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If cmbDepartment.Text = "" Then
            MsgBox("Select Department Name", MsgBoxStyle.Information)
            cmbDepartment.Focus()
            Exit Sub
        End If
        ...
        If StrSvStatus = "E" Then
            sSQL = "UPDATE tblSetDept SET deptName='" & Trim(txtDesc.Text) & "',compID='" & StrCompID & "',status=" & chkStatus.CheckState & ",shCode='" & txtshCode.Text & "' WHERE deptID='" & Trim(txtCode.Text) & "'; INSERT INTO tblEmployeeTaskHistory (trForm,task,crUser,crDate) VALUES ('" & Me.Name & "','Update Sub Department info of Sub DeptID : " & txtCode.Text & " and sub dept Name : " & txtDesc.Text & " and regid " & txtCod.Text & " and sortCode " & FK_Rep(txtshCode.Text) & "' ,'" & StrUserID & "',getdate ())  ;"
            FK_EQ(sSQL, "E", "", False, True, True)
        Else
            sSQL = "INSERT INTO tblSetDept (deptID,deptName,compID,status) VALUES ('" & Trim(txtCode.Text) & "', '" & Trim(txtDesc.Text) & "', '" & StrCompID & "'," & chkStatus.CheckState & ") ; UPDATE tblControl SET NoSubDepts=NoSubDepts+1; INSERT INTO tblEmployeeTaskHistory (trForm,task,crUser,crDate) VALUES ('" & Me.Name & "','Insert Department info of Sub DeptID : " & txtCode.Text & " and sub dept Name : " & txtDesc.Text & " and regid " & txtCod.Text & " and sortCode " & FK_Rep(txtshCode.Text) & "' ,'" & StrUserID & "',getdate ())  ;"
