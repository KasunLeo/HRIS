...
Public Class frmDeviceManagement
    ...
    Public zkMachine As zkemkeeper.IZKEM
    Public zkMachineEvent As zkemkeeper._IZKEMEvents
    '*********************************************************************************************************************************************
...
#End Region
    ...
    Private Sub Device_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ControlHandlers(Me)
        Dim sqlQ As String = "SELECT mDesc,IPaddress,Status FROM tblDeviceInfo  Order By MachinID"
        Load_InformationtoGrid(sqlQ, dgvInfo, 3)
        clr_Grid(dgvInfo)
    End Sub
...
#End Region
    ...
    Private Sub dgvInfo_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvInfo.CellClick
        txtIP.Text = dgvInfo.CurrentRow.Cells(1).Value.ToString
    End Sub
