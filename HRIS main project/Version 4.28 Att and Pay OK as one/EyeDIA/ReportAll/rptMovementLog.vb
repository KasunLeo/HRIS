...
Public Class rptMovementLog
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptMovementLog.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMovementLog
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMovementLog = New rptMovementLog()
        rpt.Site = Me.Site
        Return rpt
    End Function
