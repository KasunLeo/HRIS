...
Public Class rptVOPFirstNopay
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptVOPFirstNopay.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVOPFirstNopay
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVOPFirstNopay = New rptVOPFirstNopay()
        rpt.Site = Me.Site
        Return rpt
    End Function
