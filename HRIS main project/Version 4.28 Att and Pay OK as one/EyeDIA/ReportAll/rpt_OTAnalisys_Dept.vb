...
Public Class rpt_OTAnalisys_Dept
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_OTAnalisys_Dept.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_OTAnalisys_Dept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_OTAnalisys_Dept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_OTAnalisys_Dept = New rpt_OTAnalisys_Dept()
        rpt.Site = Me.Site
        Return rpt
    End Function
