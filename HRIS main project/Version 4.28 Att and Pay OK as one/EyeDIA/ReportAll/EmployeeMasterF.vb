...
Public Class EmployeeMasterF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.EmployeeMasterF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEmployeeMasterF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EmployeeMasterF = New EmployeeMasterF()
        rpt.Site = Me.Site
        Return rpt
    End Function
