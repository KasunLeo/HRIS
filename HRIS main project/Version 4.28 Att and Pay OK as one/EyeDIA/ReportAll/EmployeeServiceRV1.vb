...
Public Class EmployeeServiceRV1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.EmployeeServiceRV1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEmployeeServiceRV1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EmployeeServiceRV1 = New EmployeeServiceRV1()
        rpt.Site = Me.Site
        Return rpt
    End Function
