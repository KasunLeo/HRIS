...
Public Class rpt_RosterView
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_RosterView.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_RosterView
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_RosterView = New rpt_RosterView()
        rpt.Site = Me.Site
        Return rpt
    End Function
