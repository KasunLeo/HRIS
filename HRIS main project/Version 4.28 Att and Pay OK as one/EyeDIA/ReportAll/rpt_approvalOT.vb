...
Public Class rpt_approvalOT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_approvalOT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_approvalOT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_approvalOT = New rpt_approvalOT()
        rpt.Site = Me.Site
        Return rpt
    End Function
