...
Public Class rpt_ManualAdjest
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_ManualAdjest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ManualAdjest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ManualAdjest = New rpt_ManualAdjest()
        rpt.Site = Me.Site
        Return rpt
    End Function
