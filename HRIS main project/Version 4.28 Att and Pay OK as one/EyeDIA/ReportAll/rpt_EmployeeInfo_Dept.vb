...
Public Class rpt_EmployeeInfo_Dept
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_EmployeeInfo_Dept.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_EmployeeInfo_Dept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_EmployeeInfo_Dept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_EmployeeInfo_Dept = New rpt_EmployeeInfo_Dept()
        rpt.Site = Me.Site
        Return rpt
    End Function
