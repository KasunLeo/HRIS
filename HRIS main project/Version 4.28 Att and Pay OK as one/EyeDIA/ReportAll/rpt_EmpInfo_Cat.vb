...
Public Class rpt_EmpInfo_Cat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_EmpInfo_Cat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_EmpInfo_Cat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_EmpInfo_Cat = New rpt_EmpInfo_Cat()
        rpt.Site = Me.Site
        Return rpt
    End Function
