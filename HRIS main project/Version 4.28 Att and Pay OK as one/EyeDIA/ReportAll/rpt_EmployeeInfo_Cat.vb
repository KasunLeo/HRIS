...
Public Class rpt_EmployeeInfo_Cat
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_EmployeeInfo_Cat.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_EmployeeInfo_Cat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_EmployeeInfo_Cat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_EmployeeInfo_Cat = New rpt_EmployeeInfo_Cat()
        rpt.Site = Me.Site
        Return rpt
    End Function
