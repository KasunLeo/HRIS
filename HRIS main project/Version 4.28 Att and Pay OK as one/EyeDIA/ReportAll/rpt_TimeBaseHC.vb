...
Public Class rpt_TimeBaseHC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_TimeBaseHC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_TimeBaseHC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_TimeBaseHC = New rpt_TimeBaseHC()
        rpt.Site = Me.Site
        Return rpt
    End Function
