...
Public Class rpt_EmpJoinList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_EmpJoinList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_EmpJoinList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_EmpJoinList = New rpt_EmpJoinList()
        rpt.Site = Me.Site
        Return rpt
    End Function
