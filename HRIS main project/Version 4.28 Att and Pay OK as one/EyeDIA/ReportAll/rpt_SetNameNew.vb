...
Public Class rpt_SetNameNew
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_SetNameNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_SetNameNew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_SetNameNew = New rpt_SetNameNew()
        rpt.Site = Me.Site
        Return rpt
    End Function
