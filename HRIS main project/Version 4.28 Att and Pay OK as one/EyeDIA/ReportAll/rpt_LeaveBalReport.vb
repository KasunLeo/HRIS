...
Public Class rpt_LeaveBalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_LeaveBalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_LeaveBalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_LeaveBalReport = New rpt_LeaveBalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
