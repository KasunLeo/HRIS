...
Public Class rpt_EmpLvAnlisys_Dept
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_EmpLvAnlisys_Dept.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_EmpLvAnlisys_Dept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_EmpLvAnlisys_Dept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_EmpLvAnlisys_Dept = New rpt_EmpLvAnlisys_Dept()
        rpt.Site = Me.Site
        Return rpt
    End Function
