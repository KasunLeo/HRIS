...
Public Class rpt_EmpAbType_Dept
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_EmpAbType_Dept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_EmpAbType_Dept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_EmpAbType_Dept = New rpt_EmpAbType_Dept()
        rpt.Site = Me.Site
        Return rpt
    End Function
