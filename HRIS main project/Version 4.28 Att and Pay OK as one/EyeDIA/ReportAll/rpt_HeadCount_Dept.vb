...
Public Class rpt_HeadCount_Dept
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_HeadCount_Dept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_HeadCount_Dept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_HeadCount_Dept = New rpt_HeadCount_Dept()
        rpt.Site = Me.Site
        Return rpt
    End Function
