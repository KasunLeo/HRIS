...
Public Class MonthlyAbsRV1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.MonthlyAbsRV1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMonthlyAbsRV1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MonthlyAbsRV1 = New MonthlyAbsRV1()
        rpt.Site = Me.Site
        Return rpt
    End Function
