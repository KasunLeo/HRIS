...
Public Class rpt_EmpResignList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_EmpResignList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_EmpResignList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_EmpResignList = New rpt_EmpResignList()
        rpt.Site = Me.Site
        Return rpt
    End Function
