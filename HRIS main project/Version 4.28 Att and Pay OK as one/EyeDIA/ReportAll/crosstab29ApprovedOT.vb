...
Public Class crosstab29ApprovedOT
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crosstab29ApprovedOT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.crosstab29ApprovedOT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrosstab29ApprovedOT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crosstab29ApprovedOT = New crosstab29ApprovedOT()
        rpt.Site = Me.Site
        Return rpt
    End Function
