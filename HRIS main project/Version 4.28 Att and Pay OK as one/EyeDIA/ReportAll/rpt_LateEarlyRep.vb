...
Public Class rpt_LateEarlyRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_LateEarlyRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_LateEarlyRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_LateEarlyRep = New rpt_LateEarlyRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
