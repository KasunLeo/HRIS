...
Public Class rpt_OTAnalisys_Cat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_OTAnalisys_Cat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_OTAnalisys_Cat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_OTAnalisys_Cat = New rpt_OTAnalisys_Cat()
        rpt.Site = Me.Site
        Return rpt
    End Function
