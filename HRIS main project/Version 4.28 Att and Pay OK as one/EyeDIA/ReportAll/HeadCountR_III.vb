...
Public Class HeadCountR_III
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.HeadCountR_III.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHeadCountR_III
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HeadCountR_III = New HeadCountR_III()
        rpt.Site = Me.Site
        Return rpt
    End Function
