...
Public Class rptRelatonship
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptRelatonship.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRelatonship
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRelatonship = New rptRelatonship()
        rpt.Site = Me.Site
        Return rpt
    End Function
