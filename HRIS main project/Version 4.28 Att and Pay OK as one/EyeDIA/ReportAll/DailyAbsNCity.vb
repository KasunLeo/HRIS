...
Public Class DailyAbsNCity
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.DailyAbsNCity.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailyAbsNCity
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailyAbsNCity = New DailyAbsNCity()
        rpt.Site = Me.Site
        Return rpt
    End Function
