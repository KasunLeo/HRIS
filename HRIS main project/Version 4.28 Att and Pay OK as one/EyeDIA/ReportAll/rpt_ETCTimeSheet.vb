...
Public Class rpt_ETCTimeSheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_ETCTimeSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ETCTimeSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ETCTimeSheet = New rpt_ETCTimeSheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
