...
Public Class rpt_PresentINOUTOT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_PresentINOUTOT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_PresentINOUTOT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_PresentINOUTOT = New rpt_PresentINOUTOT()
        rpt.Site = Me.Site
        Return rpt
    End Function
