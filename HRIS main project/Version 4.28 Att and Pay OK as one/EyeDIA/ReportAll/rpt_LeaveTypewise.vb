...
Public Class rpt_LeaveTypewise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_LeaveTypewise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_LeaveTypewise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_LeaveTypewise = New rpt_LeaveTypewise()
        rpt.Site = Me.Site
        Return rpt
    End Function
