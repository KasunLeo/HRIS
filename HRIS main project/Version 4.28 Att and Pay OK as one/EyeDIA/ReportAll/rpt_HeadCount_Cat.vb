...
Public Class rpt_HeadCount_Cat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_HeadCount_Cat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_HeadCount_Cat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_HeadCount_Cat = New rpt_HeadCount_Cat()
        rpt.Site = Me.Site
        Return rpt
    End Function
