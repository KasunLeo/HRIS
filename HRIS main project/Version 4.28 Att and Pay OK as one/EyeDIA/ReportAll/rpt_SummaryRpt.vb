...
Public Class rpt_SummaryRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_SummaryRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_SummaryRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_SummaryRpt = New rpt_SummaryRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
