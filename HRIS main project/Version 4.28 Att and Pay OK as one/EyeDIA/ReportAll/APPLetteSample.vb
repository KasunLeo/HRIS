...
Public Class APPLetteSample
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.APPLetteSample.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAPPLetteSample
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As APPLetteSample = New APPLetteSample()
        rpt.Site = Me.Site
        Return rpt
    End Function
