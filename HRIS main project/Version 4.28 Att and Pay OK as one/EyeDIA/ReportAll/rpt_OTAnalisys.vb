...
Public Class rpt_OTAnalisys
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_OTAnalisys.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_OTAnalisys
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_OTAnalisys = New rpt_OTAnalisys()
        rpt.Site = Me.Site
        Return rpt
    End Function
