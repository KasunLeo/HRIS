...
Public Class rpt_TurnOverReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_TurnOverReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TotEmps() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_TurnOverReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_TurnOverReport = New rpt_TurnOverReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
