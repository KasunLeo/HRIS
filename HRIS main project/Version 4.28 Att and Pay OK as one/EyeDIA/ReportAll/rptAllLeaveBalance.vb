...
Public Class rptAllLeaveBalance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptAllLeaveBalance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAllLeaveBalance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAllLeaveBalance = New rptAllLeaveBalance()
        rpt.Site = Me.Site
        Return rpt
    End Function
