...
Public Class crosstab30ApprovedOT
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crosstab30ApprovedOT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.crosstab30ApprovedOT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrosstab30ApprovedOT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crosstab30ApprovedOT = New crosstab30ApprovedOT()
        rpt.Site = Me.Site
        Return rpt
    End Function
