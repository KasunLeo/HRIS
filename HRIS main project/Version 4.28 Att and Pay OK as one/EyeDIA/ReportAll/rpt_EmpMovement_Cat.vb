...
Public Class rpt_EmpMovement_Cat
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_EmpMovement_Cat.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_EmpMovement_Cat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_EmpMovement_Cat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_EmpMovement_Cat = New rpt_EmpMovement_Cat()
        rpt.Site = Me.Site
        Return rpt
    End Function
