...
Public Class rpt_OTCostingR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_OTCostingR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_OTCostingR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_OTCostingR = New rpt_OTCostingR()
        rpt.Site = Me.Site
        Return rpt
    End Function
