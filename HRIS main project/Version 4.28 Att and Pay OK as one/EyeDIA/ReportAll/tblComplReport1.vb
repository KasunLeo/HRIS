...
Public Class tblComplReport1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.tblComplReport1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedtblComplReport1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As tblComplReport1 = New tblComplReport1()
        rpt.Site = Me.Site
        Return rpt
    End Function
