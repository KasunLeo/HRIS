...
Public Class rpt_PayrollSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_PayrollSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_PayrollSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_PayrollSummary = New rpt_PayrollSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
