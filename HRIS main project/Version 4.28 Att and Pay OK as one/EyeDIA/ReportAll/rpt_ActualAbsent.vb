...
Public Class rpt_ActualAbsent
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_ActualAbsent.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ActualAbsent
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ActualAbsent = New rpt_ActualAbsent()
        rpt.Site = Me.Site
        Return rpt
    End Function
