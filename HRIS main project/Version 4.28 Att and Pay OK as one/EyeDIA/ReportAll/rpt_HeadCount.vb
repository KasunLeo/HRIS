...
Public Class rpt_HeadCount
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_HeadCount.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_HeadCount
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_HeadCount = New rpt_HeadCount()
        rpt.Site = Me.Site
        Return rpt
    End Function
