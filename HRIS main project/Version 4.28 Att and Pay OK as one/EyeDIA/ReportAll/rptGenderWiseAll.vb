...
Public Class rptGenderWiseAll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptGenderWiseAll.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGenderWiseAll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGenderWiseAll = New rptGenderWiseAll()
        rpt.Site = Me.Site
        Return rpt
    End Function
