...
Public Class rpt_DeptSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_DeptSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_DeptSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_DeptSummary = New rpt_DeptSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
