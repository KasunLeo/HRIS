...
Public Class rpt_LeaveRep_Dept
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_LeaveRep_Dept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_LeaveRep_Dept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_LeaveRep_Dept = New rpt_LeaveRep_Dept()
        rpt.Site = Me.Site
        Return rpt
    End Function
