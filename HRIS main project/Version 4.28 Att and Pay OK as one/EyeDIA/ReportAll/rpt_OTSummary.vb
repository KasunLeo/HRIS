...
Public Class rpt_OTSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_OTSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_OTSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_OTSummary = New rpt_OTSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
