...
Public Class rptGenderWiseCat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptGenderWiseCat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGenderWiseCat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGenderWiseCat = New rptGenderWiseCat()
        rpt.Site = Me.Site
        Return rpt
    End Function
