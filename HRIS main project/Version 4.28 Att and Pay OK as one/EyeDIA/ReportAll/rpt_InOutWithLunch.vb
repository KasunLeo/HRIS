...
Public Class rpt_InOutWithLunch
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_InOutWithLunch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_InOutWithLunch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_InOutWithLunch = New rpt_InOutWithLunch()
        rpt.Site = Me.Site
        Return rpt
    End Function
