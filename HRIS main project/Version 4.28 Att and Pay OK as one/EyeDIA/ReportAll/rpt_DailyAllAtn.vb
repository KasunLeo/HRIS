...
Public Class rpt_DailyAllAtn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_DailyAllAtn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_DailyAllAtn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_DailyAllAtn = New rpt_DailyAllAtn()
        rpt.Site = Me.Site
        Return rpt
    End Function
