...
Public Class rpt_OTAllSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_OTAllSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_OTAllSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_OTAllSummary = New rpt_OTAllSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
