...
Public Class rpt_AbsentOUTOT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_AbsentOUTOT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_AbsentOUTOT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_AbsentOUTOT = New rpt_AbsentOUTOT()
        rpt.Site = Me.Site
        Return rpt
    End Function
