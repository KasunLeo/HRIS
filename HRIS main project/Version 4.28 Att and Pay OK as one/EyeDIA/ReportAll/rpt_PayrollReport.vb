...
Public Class rpt_PayrollReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_PayrollReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_PayrollReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_PayrollReport = New rpt_PayrollReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
