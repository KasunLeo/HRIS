...
Public Class Rpt_monAllDed
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.Rpt_monAllDed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_monAllDed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_monAllDed = New Rpt_monAllDed()
        rpt.Site = Me.Site
        Return rpt
    End Function
