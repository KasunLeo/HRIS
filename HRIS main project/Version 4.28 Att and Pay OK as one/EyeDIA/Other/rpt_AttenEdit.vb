...
Public Class rpt_AttenEdit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_AttenEdit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_AttenEdit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_AttenEdit = New rpt_AttenEdit()
        rpt.Site = Me.Site
        Return rpt
    End Function
