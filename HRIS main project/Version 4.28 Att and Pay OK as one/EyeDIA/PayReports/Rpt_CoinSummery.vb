...
Public Class Rpt_CoinSummery
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.Rpt_CoinSummery.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_CoinSummery
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_CoinSummery = New Rpt_CoinSummery()
        rpt.Site = Me.Site
        Return rpt
    End Function
