...
Public Class rptNewPaysheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptNewPaysheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNewPaysheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNewPaysheet = New rptNewPaysheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
