...
Public Class RptSalaryItems
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.RptSalaryItems.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSalaryItems
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSalaryItems = New RptSalaryItems()
        rpt.Site = Me.Site
        Return rpt
    End Function
