...
Public Class rptNewPaysHMona
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptNewPaysHMona.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNewPaysHMona
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNewPaysHMona = New rptNewPaysHMona()
        rpt.Site = Me.Site
        Return rpt
    End Function
