...
Public Class rptNewPaysheetLHP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptNewPaysheetLHP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNewPaysheetLHP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNewPaysheetLHP = New rptNewPaysheetLHP()
        rpt.Site = Me.Site
        Return rpt
    End Function
