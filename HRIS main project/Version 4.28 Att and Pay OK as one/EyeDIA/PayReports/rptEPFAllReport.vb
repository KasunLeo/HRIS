...
Public Class rptEPFAllReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptEPFAllReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEPFAllReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEPFAllReport = New rptEPFAllReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
