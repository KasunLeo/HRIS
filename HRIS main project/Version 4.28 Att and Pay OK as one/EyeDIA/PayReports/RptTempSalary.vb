...
Public Class RptTempSalary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.RptTempSalary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptTempSalary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptTempSalary = New RptTempSalary()
        rpt.Site = Me.Site
        Return rpt
    End Function
