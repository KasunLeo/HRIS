...
Public Class RptSignatureSheet1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.RptSignatureSheet1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSignatureSheet1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSignatureSheet1 = New RptSignatureSheet1()
        rpt.Site = Me.Site
        Return rpt
    End Function
