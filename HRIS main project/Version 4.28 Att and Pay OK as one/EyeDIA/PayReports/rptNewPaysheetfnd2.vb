...
Public Class rptNewPaysheetfnd2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptNewPaysheetfnd2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNewPaysheetfnd2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNewPaysheetfnd2 = New rptNewPaysheetfnd2()
        rpt.Site = Me.Site
        Return rpt
    End Function
