...
Public Class rptLn_InstallShdl
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptLn_InstallShdl.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLn_InstallShdl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLn_InstallShdl = New rptLn_InstallShdl()
        rpt.Site = Me.Site
        Return rpt
    End Function
