...
Public Class RptSignatureShEmp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.RptSignatureShEmp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSignatureShEmp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSignatureShEmp = New RptSignatureShEmp()
        rpt.Site = Me.Site
        Return rpt
    End Function
