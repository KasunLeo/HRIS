...
Public Class rptNewPaysheetfnd
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptNewPaysheetfnd.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNewPaysheetfnd
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNewPaysheetfnd = New rptNewPaysheetfnd()
        rpt.Site = Me.Site
        Return rpt
    End Function
