...
Public Class rptPaysummery
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptPaysummery.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPaysummery
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPaysummery = New rptPaysummery()
        rpt.Site = Me.Site
        Return rpt
    End Function
