...
Public Class rpt_EmployeewisePS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rpt_EmployeewisePS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_EmployeewisePS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_EmployeewisePS = New rpt_EmployeewisePS()
        rpt.Site = Me.Site
        Return rpt
    End Function
