...
Public Class rptEditAttendance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptEditAttendance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEditAttendance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEditAttendance = New rptEditAttendance()
        rpt.Site = Me.Site
        Return rpt
    End Function
