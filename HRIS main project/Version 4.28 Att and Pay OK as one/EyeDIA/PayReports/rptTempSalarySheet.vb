...
Public Class rptTempSalarySheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptTempSalarySheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTempSalarySheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTempSalarySheet = New rptTempSalarySheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
