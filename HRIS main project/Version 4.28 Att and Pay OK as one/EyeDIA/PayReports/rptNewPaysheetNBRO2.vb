...
Public Class rptNewPaysheetNBRO2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptNewPaysheetNBRO2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptNewPaysheetNBRO2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_addres() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptNewPaysheetNBRO2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNewPaysheetNBRO2 = New rptNewPaysheetNBRO2()
        rpt.Site = Me.Site
        Return rpt
    End Function
