...
Public Class rptServiceCharge
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptServiceCharge.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptServiceCharge
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptServiceCharge = New rptServiceCharge()
        rpt.Site = Me.Site
        Return rpt
    End Function
