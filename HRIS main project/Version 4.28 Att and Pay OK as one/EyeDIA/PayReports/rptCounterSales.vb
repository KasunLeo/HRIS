...
Public Class rptCounterSales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptCounterSales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCounterSales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCounterSales = New rptCounterSales()
        rpt.Site = Me.Site
        Return rpt
    End Function
