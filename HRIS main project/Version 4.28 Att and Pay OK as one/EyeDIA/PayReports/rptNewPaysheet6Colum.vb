...
Public Class rptNewPaysheet6Colum
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptNewPaysheet6Colum.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptNewPaysheet6Colum.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNewPaysheet6Colum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNewPaysheet6Colum = New rptNewPaysheet6Colum()
        rpt.Site = Me.Site
        Return rpt
    End Function
