...
Public Class rptActiveEmployeeList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptActiveEmployeeList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptActiveEmployeeList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptActiveEmployeeList = New rptActiveEmployeeList()
        rpt.Site = Me.Site
        Return rpt
    End Function
