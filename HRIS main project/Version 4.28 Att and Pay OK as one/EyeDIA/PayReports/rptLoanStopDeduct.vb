...
Public Class rptLoanStopDeduct
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HRISforBB.rptLoanStopDeduct.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLoanStopDeduct
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLoanStopDeduct = New rptLoanStopDeduct()
        rpt.Site = Me.Site
        Return rpt
    End Function
